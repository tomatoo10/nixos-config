# Shared desktop/workstation defaults.
#
# This module is intentionally not imported by headless servers. It combines the
# baseline desktop services, command-not-found database, portals, locale/time,
# convenience packages, and user-facing environment variables used by ryu/sora.
{
  pkgs,
  config,
  inputs,
